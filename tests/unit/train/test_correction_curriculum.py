...
def test_generated_token_ratio_warmup_ramp_and_plateau():
    ...
    assert _scheduled_trainer(60)._current_correction_generated_token_ratio() == 0.25
    assert _scheduled_trainer(90)._current_correction_generated_token_ratio() == 0.25
...
def test_zero_ramp_switches_to_target_after_warmup():
    ...
    assert trainer._current_correction_generated_token_ratio() == 0.25

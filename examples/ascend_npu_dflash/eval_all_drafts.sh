...
say "### settings   : DATASET=$DATASET CONCURRENCY=$CONCURRENCY KEEP_WARMUP=$KEEP_WARMUP MAX_NEW=$MAX_NEW NUM_PROMPTS=${NUM_PROMPTS:-0 (full)} NUM_SPEC=${NUM_SPEC:-5 (serve default)}"

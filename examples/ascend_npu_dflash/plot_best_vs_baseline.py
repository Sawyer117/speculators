...
RUNS = [
    ...
    #    FINAL 0.5ep 3.84 → 5.0ep 4.40 (99.5%); non-chat 4.726 = 100.6%; speedup 1.39x vs AR. Use
    ...
    {
        # 4.0ep: mean 4.39 = 99.4%; NON-CHAT 4.726 PASSES released 4.699 (100.6%). gsm8k 103.7%,
        # mbpp 100.9%. The 3.5ep "plateau" was small-sample bounce -- humaneval/mbpp/mt-bench
        # alternate and cancel; gsm8k (n=1309) and math500 (n=490) rise monotonically throughout.
        "label": "current best 4.0ep",
        "al": {"gsm8k": 4.831, "math500": 4.573, "humaneval": 4.924, "mbpp": 4.574, "mt-bench": 3.062},
        "pos": {
            "gsm8k":     [93.56, 85.34, 76.48, 67.93, 59.75],
            "math500":   [90.95, 81.17, 71.40, 61.63, 52.15],
            "humaneval": [95.16, 88.46, 78.25, 69.95, 60.55],
            "mbpp":      [91.93, 81.94, 71.07, 60.91, 51.57],
            "mt-bench":  [75.99, 52.74, 36.00, 24.64, 16.83],
        },
    },
    {
        # 4.5ep: mean 4.41 = 99.7%; THREE datasets above released (gsm8k 103.9, mbpp 100.4,
        # humaneval 100.2). gsm8k deltas flat at +0.009 twice running; math500 posts its first
        # decline -> convergence, with large-sample support this time. 5.0ep confirms.
        "label": "current best 4.5ep",
        "al": {"gsm8k": 4.840, "math500": 4.564, "humaneval": 4.954, "mbpp": 4.553, "mt-bench": 3.122},
        "pos": {
            "gsm8k":     [93.57, 85.48, 76.91, 68.18, 59.87],
            "math500":   [90.84, 81.05, 71.10, 61.33, 52.06],
            "humaneval": [95.05, 88.97, 78.67, 70.98, 61.69],
            "mbpp":      [91.53, 81.54, 70.67, 60.47, 51.09],
            "mt-bench":  [76.77, 54.14, 37.43, 25.84, 18.00],
        },
    },
    {
        # 5.0ep FINAL (run complete, LR annealed to 0): mean 4.396 = 99.5%; non-chat 4.726 = 100.6%.
        # CONVERGED -- gsm8k deltas hold +0.009 for three checkpoints; last three means span 0.0138.
        # Deliverable checkpoint. Speedup vs AR @conc48 = 1.39x mean (1.18-1.64x).
        "label": "current best 5.0ep",
        "al": {"gsm8k": 4.849, "math500": 4.565, "humaneval": 4.933, "mbpp": 4.555, "mt-bench": 3.079},
        "pos": {
            "gsm8k":     [93.68, 85.68, 77.01, 68.47, 60.08],
            "math500":   [91.01, 81.34, 71.02, 61.19, 51.91],
            "humaneval": [95.11, 88.48, 78.59, 70.05, 61.09],
            "mbpp":      [91.61, 81.66, 70.75, 60.52, 50.97],
            "mt-bench":  [75.66, 53.39, 36.48, 25.17, 17.17],
        },
    },
